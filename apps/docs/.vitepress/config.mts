            ...
            '/zh/api/': [
              {
                ...
                items: [
                  ...
                  { text: 'auth', link: '/zh/api/auth/src/README' },
                  { text: 'config', link: '/zh/api/config/src/README' },
                  { text: 'context', link: '/zh/api/context/src/README' },
                  { text: 'core', link: '/zh/api/core/src/README' },
                  { text: 'native-bridge', link: '/zh/api/native-bridge/src/README' },
                  { text: 'permission', link: '/zh/api/permission/src/README' },
                  { text: 'plugin-runtime', link: '/zh/api/plugin-runtime/src/README' },
                  { text: 'plugin-sdk', link: '/zh/api/plugin-sdk/src/README' },
                  { text: 'provider-anthropic', link: '/zh/api/provider-anthropic/src/README' },
                  { text: 'provider-kit', link: '/zh/api/provider-kit/src/README' },
                  { text: 'provider-openai', link: '/zh/api/provider-openai/src/README' },
                  { text: 'router', link: '/zh/api/router/src/README' },
                  { text: 'shared', link: '/zh/api/shared/src/README' },
                  { text: 'skills-runtime', link: '/zh/api/skills-runtime/src/README' },
                  { text: 'storage', link: '/zh/api/storage/src/README' },
                  { text: 'telemetry', link: '/zh/api/telemetry/src/README' },
                  { text: 'tool-kit', link: '/zh/api/tool-kit/src/README' },
                  { text: 'tools', link: '/zh/api/tools/src/README' },
                  { text: 'ui', link: '/zh/api/ui/src/README' },
                ],
              },
            ],
            '/zh/docs/': [
