...
cp -r examples/plugins/plugin-status-demo ~/.volund/plugins-dev/volund-plugin-status-demo
...
```bash
ln -s "$PWD/examples/plugins/plugin-status-demo" ~/.volund/plugins-dev/volund-plugin-status-demo
# 或
VOLUND_DEV_PLUGINS=examples/plugins/plugin-status-demo volund
```
